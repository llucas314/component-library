...
storiesOf("Button", module)
	...
	.add("Add Favorite", () => (
		<Button icon="like" type="primary" label="Add To Favorites" faded />
	))
	.add("Cart", () => <Button icon="cart" type="primary" faded />)
	.add("Favorite", () => <Button icon="like" type="primary" faded />);
